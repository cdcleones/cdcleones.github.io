...
if (anio>=2019){
			  ...
			  /* 2022 */
			  $('#btnRLV122').click(function(){ if ($('#RLV122').is (':hidden')){ $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#RLV122').show(); } else $('#RLV122').hide(); });
			  $('#btnNLV122').click(function(){ if ($('#NLV122').is (':hidden')){ $('#RLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#NLV122').show(); } else $('#NLV122').hide(); });
			  $('#btnRLV222').click(function(){ if ($('#RLV222').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#RLV222').show(); } else $('#RLV222').hide(); });
			  $('#btnNLM122').click(function(){ if ($('#NLM122').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#NLM122').show(); } else $('#NLM122').hide(); });
			  $('#btnNLM222').click(function(){ if ($('#NLM222').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#NLM222').show(); } else $('#NLM222').hide(); });
			  $('#btnRLM122').click(function(){ if ($('#RLM122').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#RLM122').show(); } else $('#RLM122').hide(); });
			  $('#btnRLM222').click(function(){ if ($('#RLM222').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#RLM222').show(); } else $('#RLM222').hide(); });
			  $('#btnNLM322').click(function(){ if ($('#NLM322').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM422').hide(); $('#RLM322').hide(); $('#NLM322').show(); } else $('#NLM322').hide(); });
			  $('#btnNLM422').click(function(){ if ($('#NLM422').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#RLM322').hide(); $('#NLM422').show(); } else $('#NLM422').hide(); });
			  $('#btnRLM322').click(function(){ if ($('#RLM322').is (':hidden')){ $('#RLV122').hide(); $('#NLV122').hide(); $('#RLV222').hide(); $('#NLM122').hide(); $('#NLM222').hide(); $('#RLM122').hide(); $('#RLM222').hide(); $('#NLM322').hide(); $('#NLM422').hide(); $('#RLM322').show(); } else $('#RLM322').hide(); });
