...
if (anio>=2019){
			  ...
			  /* 2025 */
			  $('#btnRLV125').click(function(){ if ($('#RLV125').is (':hidden')){ $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#RLV125').show(); } else $('#RLV125').hide(); });
			  $('#btnNLM125').click(function(){ if ($('#NLM125').is (':hidden')){ $('#RLV125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#NLM125').show(); } else $('#NLM125').hide(); });
			  $('#btnRLM125').click(function(){ if ($('#RLM125').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#RLM125').show(); } else $('#RLM125').hide(); });
			  ...
			  $('#btnNLF125').click(function(){ if ($('#NLF125').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#NLF125').show(); } else $('#NLF125').hide(); });
			  $('#btnRLF125').click(function(){ if ($('#RLF125').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#RLF125').show(); } else $('#RLF125').hide(); });
			  $('#btnNLF225').click(function(){ if ($('#NLF225').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#RLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#NLF225').show(); } else $('#NLF225').hide(); });
			  $('#btnRLF225').click(function(){ if ($('#RLF225').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#NLG125').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#RLF225').show(); } else $('#RLF225').hide(); });
			  $('#btnNLG125').click(function(){ if ($('#NLG125').is (':hidden')){ $('#RLV125').hide(); $('#NLM125').hide(); $('#RLM125').hide(); $('#RLV225').hide(); $('#NLM225').hide(); $('#RLM225').hide(); $('#NLV125').hide(); $('#NLV225').hide(); $('#RLV325').hide(); $('#NLF125').hide(); $('#RLF125').hide(); $('#NLF225').hide(); $('#RLF225').hide(); $('#RLG125').hide(); $('#NLG225').hide(); $('#RLG225').hide(); $('#NLG125').show(); } else $('#NLG125').hide(); });
